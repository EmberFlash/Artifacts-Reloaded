...
import archived.artifactsreloaded.api.main.IItemIconAPI;
...
private final HashMap<String, HashMap<ItemArmor.ArmorMaterial, AbstractModelTexture>> modelMap = new HashMap<String, HashMap<ItemArmor.ArmorMaterial, AbstractModelTexture>>();
...
public void registerModelTexture(String icon, ItemArmor.ArmorMaterial material, String modelTexture, String modelColor) {
	HashMap<ItemArmor.ArmorMaterial, AbstractModelTexture> innerMap = modelMap.get(icon);

	if(innerMap == null) {
		innerMap = new HashMap<ItemArmor.ArmorMaterial, AbstractModelTexture>();
	}
...
public IIcon registerIcons(IIconRegister iconReg) {
	...
	HashMap<ItemArmor.ArmorMaterial, String> modelsLayer1 = new HashMap<ItemArmor.ArmorMaterial, String>();
	modelsLayer1.put(ItemArmor.ArmorMaterial.CLOTH, "artifacts:textures/models/armor/leather_default_layer1.png");
	modelsLayer1.put(ItemArmor.ArmorMaterial.CHAIN, "artifacts:textures/models/armor/chain_default_layer1.png");
	modelsLayer1.put(ItemArmor.ArmorMaterial.IRON, "artifacts:textures/models/armor/iron_default_layer1.png");
	modelsLayer1.put(ItemArmor.ArmorMaterial.GOLD, "artifacts:textures/models/armor/gold_default_layer1.png");
	modelsLayer1.put(ItemArmor.ArmorMaterial.DIAMOND, "artifacts:textures/models/armor/diamond_default_layer1.png");

	HashMap<ItemArmor.ArmorMaterial, String> modelsLayer2 = new HashMap<ItemArmor.ArmorMaterial, String>();
	modelsLayer2.put(ItemArmor.ArmorMaterial.CLOTH, "artifacts:textures/models/armor/leather_default_layer2.png");
	modelsLayer2.put(ItemArmor.ArmorMaterial.CHAIN, "artifacts:textures/models/armor/chain_default_layer2.png");
	modelsLayer2.put(ItemArmor.ArmorMaterial.IRON, "artifacts:textures/models/armor/iron_default_layer2.png");
	modelsLayer2.put(ItemArmor.ArmorMaterial.GOLD, "artifacts:textures/models/armor/gold_default_layer2.png");
	modelsLayer2.put(ItemArmor.ArmorMaterial.DIAMOND, "artifacts:textures/models/armor/diamond_default_layer2.png");

	HashMap<ItemArmor.ArmorMaterial, String> colorsLayer1 = new HashMap<ItemArmor.ArmorMaterial, String>();
	colorsLayer1.put(ItemArmor.ArmorMaterial.CLOTH, "artifacts:textures/models/armor/color_default_layer1.png");
	colorsLayer1.put(ItemArmor.ArmorMaterial.CHAIN, "artifacts:textures/models/armor/color_default_layer1.png");
	colorsLayer1.put(ItemArmor.ArmorMaterial.IRON, "artifacts:textures/models/armor/color_default_layer1.png");
	colorsLayer1.put(ItemArmor.ArmorMaterial.GOLD, "artifacts:textures/models/armor/color_default_layer1.png");
	colorsLayer1.put(ItemArmor.ArmorMaterial.DIAMOND, "artifacts:textures/models/armor/color_default_layer1.png");

	HashMap<ItemArmor.ArmorMaterial, String> colorsLayer2 = new HashMap<ItemArmor.ArmorMaterial, String>();
	colorsLayer2.put(ItemArmor.ArmorMaterial.CLOTH, "artifacts:textures/models/armor/color_default_layer2.png");
	colorsLayer2.put(ItemArmor.ArmorMaterial.CHAIN, "artifacts:textures/models/armor/color_default_layer2.png");
	colorsLayer2.put(ItemArmor.ArmorMaterial.IRON, "artifacts:textures/models/armor/color_default_layer2.png");
	colorsLayer2.put(ItemArmor.ArmorMaterial.GOLD, "artifacts:textures/models/armor/color_default_layer2.png");
	colorsLayer2.put(ItemArmor.ArmorMaterial.DIAMOND, "artifacts:textures/models/armor/color_default_layer2.png");
	...
	for(int i=0; i < iconList.size(); ++i) {
		...
		if(modelMap.get(a.icon) != null) {
			HashMap<ItemArmor.ArmorMaterial, AbstractModelTexture> thisMap = modelMap.get(a.icon);
			HashMap<ItemArmor.ArmorMaterial, String> normalMap = new HashMap<ItemArmor.ArmorMaterial, String>();
			HashMap<ItemArmor.ArmorMaterial, String> colorMap = new HashMap<ItemArmor.ArmorMaterial, String>();
			for(ItemArmor.ArmorMaterial material : thisMap.keySet()) {
