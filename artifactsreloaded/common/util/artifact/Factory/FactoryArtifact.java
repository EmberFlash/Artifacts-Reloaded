...
import artifactsreloaded.api.ArtifactAPI;
import archived.artifactsreloaded.api.main.IArtifactAPI;
import archived.artifactsreloaded.api.main.interfaces.IArtifactComp;
import archived.artifactsreloaded.common.components.ComponentNull;
import artifactsreloaded.common.components.effects.*;
import artifactsreloaded.common.item.Artifact;

import archived.artifactsreloaded.common.components.effects.*;
import archived.artifactsreloaded.common.item.ArtifactArmour;
...
private ItemStack applyRandomArmorEffects(ItemStack artifact) {
	...
	if(ar.getArmorMaterial().equals(ItemArmor.ArmorMaterial.CLOTH)) {
		matName = "Leather";
		r4 = 0;
	}
	if(ar.getArmorMaterial().equals(ItemArmor.ArmorMaterial.CHAIN)) {
		matName = "Chain";
		r4 = 1;
	}
	if(ar.getArmorMaterial().equals(ItemArmor.ArmorMaterial.IRON)) {
		matName = "Iron";
		r4 = 2;
	}
	if(ar.getArmorMaterial().equals(ItemArmor.ArmorMaterial.GOLD)) {
		matName = "Gold";
		r4 = 4;
	}
	if(ar.getArmorMaterial().equals(ItemArmor.ArmorMaterial.DIAMOND)) {
		matName = "Diamond";
		r4 = 3;
	}
